...
python try_different_thresholds_repressed_response.py ${data_fname} ${perturbation_sample} ${control_sample} ${unweighted_nw_fname} ${path_length_thresh} ${out_dir}/Pij_zscores.txt ${out_dir}/thresh_TopNet_sizes.txt
