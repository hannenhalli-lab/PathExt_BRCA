...
def combine_data_get_sp_paths_costs_activated(G_unweighted, SI, num_perturbed_samples, num_control_samples, response_nw_fname, paths):
...
Pij, SI = combine_data_get_sp_paths_costs_activated(G_unweighted, SI, num_perturbed_samples, num_control_samples, response_nw_fname, []) # Give an empty list as the paths argument
...
for i in range(num_trials):
	...
	Pij, randomized_SI = combine_data_get_sp_paths_costs_activated(G_unweighted, randomized_SI, num_perturbed_samples, num_control_samples, response_nw_fname, list(Pij.index))
